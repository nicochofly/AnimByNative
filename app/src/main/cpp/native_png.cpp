...
JNINativeMethod methods[] = {
        {"loadPNGImage", "(Ljava/lang/String;Landroid/view/Surface;)V", (void *) Java_com_nico_animbynative_PngLoader_loadPNGImage}
};
...
jint registerNativeMethod(JNIEnv *env) {
    //com.nico.animbynative
    jclass cl = env->FindClass("com/nico/animbynative/PngLoader");
...
extern "C" JNIEXPORT void JNICALL Java_com_nico_animbynative_PngLoader_loadPNGImage
        (JNIEnv * env, jobject obj, jstring jpegPath, jobject surface){
